...
public class Jugador implements Comparable <Jugador>{
    ...
    public double calcularRendimiento(){
        ...
        switch (this.posInt){
            ...
            break;
            case 2:
                p = 0.23; g = 0.01; t = 0.14; e = 0.6; a = 0.02;
            ...
            break;
            case 3:
                p = 0.63; g = 0.01; t = 0.05; e = 0.25; a = 0.06;
                rendimiento = this.getStats().getTackles()*e + this.getStats().getPases()*p + this.getStats().getGoles()*g + this.getStats().getAsistencias()*a + this.getStats().getTiros()*t;
            break;
            case 4:
                p = 0.55; g = 0.04; t = 0.26; e = 0.1; a = 0.05;
                rendimiento = this.getStats().getTackles()*e + this.getStats().getPases()*p + this.getStats().getGoles()*g + this.getStats().getAsistencias()*a + this.getStats().getTiros()*t;
            break;
            case 5:
                p = 0.38; g = 0.08; t = 0.49; e = 0.01; a = 0.04;
                rendimiento = this.getStats().getTackles()*e + this.getStats().getPases()*p + this.getStats().getGoles()*g + this.getStats().getAsistencias()*a + this.getStats().getTiros()*t;
                
            break;
            case 6:
                p = 0.11; g = 0.13; t = 0.74; e = 0.01; a = 0.01;
                rendimiento = this.getStats().getTackles()*e + this.getStats().getPases()*p + this.getStats().getGoles()*g + this.getStats().getAsistencias()*a + this.getStats().getTiros()*t;
            break;
            default:
                rendimiento = 0;
    ...
    public void definirSalario(){
        ...
        switch (this.medias[0]){
            ...
            break;
            case 20:
                this.salario += 1150000;
            break;
            case 21:
                this.salario += 2950000;
            break;
            case 22:
                this.salario += 6055000;
            break;
            case 23:
                this.salario += 9500000;
            break;
            case 24:
                this.salario += 14500000;
            break;
            case 25:
                this.salario += 19500000;
            break;
            case 26:
                this.salario += 23500000;
            break;
        }
        ...
        if ((this.edad >= 24)&&(this.edad<=26)) salario*=0.95;
        else if ((this.edad >= 27)&&(this.edad<=29)) salario*=0.9;
        else if ((this.edad >= 30)&&(this.edad<=33)) salario*=0.8;
        else if ((this.edad >= 34)&&(this.edad<=36)) salario*=0.7;
        else if ((this.edad > 36))salario*=0.6;
        
    }
    public void calcularExpTest(double rendMedio){
        double parteMinutos, parteRend;
        parteMinutos = ((double)this.getStats().getMinutos()/5)-(this.edad*20)*(1-((double)this.medias[0]/50));
        parteRend = ((this.rendimiento - rendMedio)*15);
        this.exp = (int)(parteMinutos*0.3 + parteRend*0.7);
    }
}
